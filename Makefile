...
##### microcontroller projects simple with Linux 
...
# avrdude requires 'm8')
PROGRAMMER_MCU=$(avrdude_mcu_string)
...
# 
AVRDUDE_PROGRAMMERID=$(avrdude_programmer)

# port--serial or parallel port to which your 
# hardware programmer is attached
#
AVRDUDE_PORT=$(avrdude_prog_port)
...
# compiler
CFLAGS=-I. $(INC) -g -DF_CPU=$(freq_cpu) -mmcu=$(MCU) -O$(OPTLEVEL) \
